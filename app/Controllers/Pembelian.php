...
class Pembelian extends BaseController
{
    ...
    public function inputdata()
    {
        ...
        if (!isset($_POST['id_mainan']) and !isset($_POST['nama_vendor']) and !isset($_POST['nama_mainan']) and !isset($_POST['jumlah_mainan']) and !isset($_POST['harga_beli']) and !isset($_POST['total_pembelian'])) {
